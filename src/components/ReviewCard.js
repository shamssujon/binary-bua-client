	...
	return (
		<div className="flex h-full flex-col justify-between rounded border bg-white p-4 shadow-md shadow-slate-500/10 md:p-8">
			...
			<div className="flex items-center gap-4">
				<div className="grid aspect-square h-14 w-14 place-content-center overflow-hidden rounded-full border-2 border-blue-900/50">
					{reviewerPhoto ? (
						<img src={reviewerPhoto} alt="" className="h-full w-full object-cover" />
					) : (
